...
class QuestionsTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let next = segue.destination as! EditorTableViewController
        ...
        if segue.identifier == "editQuestion"{
            ...
            next.owner = self
            next.index = qcontroller.arrQuestions.count 
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return qcontroller.arrQuestions.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = qcontroller.arrQuestions[indexPath.row].question
